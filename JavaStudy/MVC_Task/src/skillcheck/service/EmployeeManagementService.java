...
// [ここへ記述]
import java.bean.EmployeeBean;
import java.bean.ResponseBean;
import java.constant.ConstMessage;
import java.constant.ConstSQL;
import java.dao.EmployeeDao;
import java.exception.MVCException;
import java.logger.Logger;
/**
 * 社員情報管理サービス
 * <pre>
 * 当該クラスで提供する機能
    ...
    private ResponseBean executeDBAccess(final ExecuteCase eCase, final List<EmployeeBean> pEmployeeBeanList) throws MVCException {
        ...
        try {
            ...
            while (this.resultSet.next()) {
                ...
                employeeBean.setString("empId");
                employeeBean.setString("password");
                employeeBean.setString("name");
                employeeBean.setString("mail");
                employeeBean.setString("programingLanguage");
                employeeBean.setString("comment");
