...
public class Nanaumi implements OrderFromMotoki, OrderFromShihandai {
	 ...
	 * 以下はOverrideしたメソッドの処理を実行する際に、フラグを立てて該当する処理をさせるメソッドの例
	 */
	...
	@Override	//アノテーション	コンパイラで出力される警告メッセージを抑制したり、実行環境によってプログラムの動作を変更したりする
	...
	@Override
	//セブンイレブン行けや！：　OrderFromMotokiのおじゃま虫メソッド
